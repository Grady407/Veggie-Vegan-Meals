...
class App extends Component {
  ...
  render() {
    ...
    return (
      <Router>
        <div>
        <Navigation handleLogout = {this.handleLogout} auth = { this.state.auth } />
        ...
        <Route exact path = "/MealPrep" render = {()=> {
          if(loggedIn){
            return <MealPrep />
          } else{
            return <SignIn 
            ...
            <Route exact path = "/DidYouKnow" render = {()=> {
          if(loggedIn){
            return <DidYouKnow />
          } else{
            return <SignIn 
            ...
            />
                  ...
                  <Route exact path = "/FoodFight" render = {()=> {
          if(loggedIn){
            return <FoodFight />
          } else{
            return <SignIn 
